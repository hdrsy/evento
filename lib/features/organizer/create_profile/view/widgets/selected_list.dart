...
class SelectState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String selectedState = organizerCreateProfileController.states[0];
    return Center(
      child: Container(
            ...
            Expanded(
              child: CupertinoPicker(
                ...
                onSelectedItemChanged: (index) {
                  selectedState =
                      organizerCreateProfileController.states[index];
                },
                children: List<Widget>.generate(
                    organizerCreateProfileController.states.length, (index) {
                  return Center(
                    child: Text(
                      organizerCreateProfileController.states[index],
