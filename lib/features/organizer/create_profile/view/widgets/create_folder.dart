...
final OrganizerCreateProfileController organizerCreateProfileController=Get.find();
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller: organizerCreateProfileController.createFolderName,
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ButtonWidget(
                        onPressed: () async {
                          organizerCreateProfileController.onPressCreateFolder();
                          
                          Get.toNamed('/AddMediaInFolderScreen',arguments: [organizerCreateProfileController.createFolderName.text,organizerCreateProfileController.foldersModel.length-1]);
                          },
                        text:tr(  "Create"),
                        options: ButtonOptions(
                          width: 100,
