...
import '../controller/booking_detailes_in_event_for_organizer_controller.dart';
...
class BookingDetailesInEventForOrganizerScreen extends StatelessWidget {
  BookingDetailesInEventForOrganizerScreen({super.key});
  final BookingDetailesInEventForOrganizerController bookingDetailesController =
      Get.put(BookingDetailesInEventForOrganizerController());
  @override
          ...
          child: Column(
            children: [
              ...
              ...List.generate(
                  ...
                  (index) => BookingDetailesInEventForOrganizerBooking(
                        ticketModel:
