            ...
            Expanded(
              child: CupertinoPicker(
                ...
                onSelectedItemChanged: (index) {
                 selectedState= serviceProviderCreateProfileController.states[ index];
                },
                children: List<Widget>.generate(serviceProviderCreateProfileController.states.length, (index) {
                  return Center(child: Text(serviceProviderCreateProfileController.states[index],style: customTextStyle.titleSmall.override(
            ...
            Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ButtonWidget(
                      onPressed: () async {
                    serviceProviderCreateProfileController.selectedState=selectedState;
                    serviceProviderCreateProfileController.update();
                    Get.back();
                      },
                      text:  "Done" ,
                      options: ButtonOptions(
