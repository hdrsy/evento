      ...
      body: Container(
          ...
          child: Obx(
            () => SingleChildScrollView(
              controller: choiceOrganizerCategoryController.scrollController,
              child: Column(
                ...
                children: [
                  ...
                  searchTextField(
                      controller:
                          choiceOrganizerCategoryController.searchController,
                      onChanged: (value) {}),
                  ...
                  Padding(
                    ...
                    child: ButtonWidget(
                      onPressed: () {
                        choiceOrganizerCategoryController.onPressDone();
                  ...
                  ...List.generate(
                    choiceOrganizerCategoryController.errorMessage.length,
                    (index) => ErrorMessages(
                      message:
                          choiceOrganizerCategoryController.errorMessage[index],
                    ),
                  )
                ].divide(const SizedBox(
                    height: 10)), // Dividing widgets with spacing.
              ),
            ),
          )),
    );
