            ...
            Expanded(
              child: CupertinoPicker(
                ...
                onSelectedItemChanged: (index) {
                 selectedState= step8controller.states[ index];
                },
                children: List<Widget>.generate(step8controller.states.length, (index) {
                  return Center(child: Text(step8controller.states[index],style: customTextStyle.titleSmall.override(
