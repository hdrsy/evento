...
class Offers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => offersController.itemList.isEmpty
...
buildOffersList() {
  ...
  return Container(
      ...
      child: buildListShow(
          body: List.generate(
              offersController.itemList.length,
              (index) => offerImage(
                  "/storage/${offersController.itemList[index].images[0]}",
                  offersController.itemList[index].offer.eventId,
                  offersController.itemList[index].offer.percent)),
