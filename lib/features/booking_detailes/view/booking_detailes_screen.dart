...
class BookingDetailesScreen extends StatelessWidget {
  const BookingDetailesScreen({super.key});
  ...
  child: Column(
    ...
    children: [
      ...
      Padding(
        ...
        child: ButtonWidget(
          onPressed: () async {
            await showButtonSheet(context: context, widget: const ReviewEventWidget(), height: 450);
          },
          text: "Review Event",
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconWithContainer(
                      ...
                      onTap: () async {
    showButtonSheet(context: context, widget: const TotalWidget(), height:250);
                      },
