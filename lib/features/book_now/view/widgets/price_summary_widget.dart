...
final BookNowController bookNowController=Get.find();
  ...
  Widget build(BuildContext context) {
    return  GetBuilder<BookNowController>(
      builder: (context) {
        return Container(
...
child:Column(
  ...
  children: [
        ...
        priceElement("Ticket",bookNowController.eventDetailsModel.ticketPrice),
    bookNowController.ticketList[index].selectedClass==null?SizedBox.shrink():    priceElement(bookNowController.ticketList[index].selectedClass!.code,bookNowController.ticketList[index].selectedClass!.ticketPrice),
