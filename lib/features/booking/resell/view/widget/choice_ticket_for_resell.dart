...
class ChoiceTicketForReSellWidget extends StatelessWidget {
  ChoiceTicketForReSellWidget({Key? key, required this.bookings})
      : super(key: key);
  final List<Booking> bookings;
  final ReSellController cancelBookingController = Get.put(ReSellController());
  @override
        ...
        children: [
          ...
          Padding(
            ...
            child: Obx(
              () => ButtonWidget(
                onPressed: () async {
                  if (cancelBookingController.selectedTicket.value != 0) {
                    Get.back();
                    showButtonSheet(
                        context: context,
                ...
                options: ButtonOptions(
                  ...
                  color: cancelBookingController.selectedTicket.value != 0
...
class ddd extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ReSellController>(
            ...
            Row(
              ...
              children: [
                Theme(
                  ...
                  child: Checkbox(
                    value: c.selectedTicket.value == (eventBooking.id),
                    onChanged: (value) {
                      c.selectedTicket.value =
                          c.selectedTicket.value == value ? 0 : eventBooking.id;
                      c.update();
                    },
