...
import 'package:evento/features/venue/venue_detailes/controller/venue_detailes_controller.dart';
...
class VenueDetailesForUserScreen extends StatelessWidget {
  VenueDetailesForUserScreen({super.key});
  final VenueDetailesForUserController venueDetailesController =
      Get.put(VenueDetailesForUserController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(
          () => venueDetailesController.isLoading.value
              ? Center(
                  child: CircularProgressIndicator(
                    color: customColors.primary,
                  ),
                )
              : venueDetailesController.isError.value
                  ? EmptyData(
